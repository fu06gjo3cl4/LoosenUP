...
class Fatigue_PeriodViewController: UIViewController {
    ...
    @IBOutlet weak var lb_title1: UILabel!{
        didSet{
            UIViewService.setBackgroundColor(view: lb_title1, color: Const.Main_Color.cgColor)
        }
    }
    
    @IBOutlet weak var lb_title2: UILabel!{
        didSet{
            UIViewService.setBackgroundColor(view: lb_title2, color: Const.Main_Color.cgColor)
        }
    }
    
    @IBOutlet weak var lb_title3: UILabel!{
        didSet{
            UIViewService.setBackgroundColor(view: lb_title3, color: Const.Main_Color.cgColor)
        }
    }
